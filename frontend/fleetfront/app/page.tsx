...
import { Truck, Users, Banknote, ShieldCheck, Zap, Globe, ArrowRight, Activity } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#FFFFFF] text-[#000000] font-sans selection:bg-[#000000] selection:text-[#FFFFFF]">
      ...
      <section className="relative min-h-[90vh] pt-10 flex flex-col lg:flex-row border-b border-[#FFFFFF]">
        ...
        <div className="flex-1 flex flex-col justify-center px-6 py-20 lg:p-20 xl:p-32 z-10">
          <h3 className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#1A1A1A] mb-8">
            FleetOS — Edition 1.0
          </h3>
          ...
          <p className="mt-12 text-[#1A1A1A] text-lg md:text-xl font-light max-w-md leading-relaxed">
      ...
      <section id="features" className="bg-[#FFFFFF] border-b border-[#FFFFFF]">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          {/* Header Block */}
          <div className="p-12 lg:p-24 border-b lg:border-b-0 lg:border-r border-[#1A1A1A] flex flex-col justify-center">
            ...
            {[
              ...
              >
                <div className="flex items-start md:items-center gap-8 md:gap-16 mb-4 md:mb-0">
                  <span className="text-xs font-['Playfair_Display',serif] italic text-[#1A1A1A]">{module.number}</span>
                ...
                <div className="flex items-center justify-between md:w-1/2 ml-12 md:ml-0">
                  ...
                  <ArrowRight className="w-5 h-5 text-[#1A1A1A] group-hover:text-[#000000] group-hover:translate-x-2 transition-all duration-300" strokeWidth={1} />
                </div>
              </Link>
            ))}
          </div>
